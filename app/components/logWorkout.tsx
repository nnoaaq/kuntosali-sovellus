...
export function ActiveWorkout({ workout }: { workout: Workout }) {
  ...
  return (
    <div className="border w-100 border-gray-400 rounded flex flex-col gap-2">
      ...
      <div>
        <div className="flex flex-col gap-2 p-2">
          {workout.WorkoutTemplates.WorkoutTemplateExercises.map(
            (workoutExercise) => (
              <div
                  ...
                  <table className="w-full">
                    ...
                    <tbody>
                      {workoutExercise.WorkoutTemplateSets.map((workoutSet) => (
                        ...
                        >
                          <td>
                            <div className="border border-gray-400 mx-auto w-[15px] h-[15px] rounded-full hover:bg-green-600 cursor-pointer"></div>
                          </td>
